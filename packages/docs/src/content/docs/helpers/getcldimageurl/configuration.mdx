...
:::tip
Configuration for getCldImageUrl is the same as [CldImage](/cldimage/configuration), which both use the same underlying API.
:::
...
:::tip
This disables [optimization](#optimization) and [responsive sizing](/guides/responsive-images)
