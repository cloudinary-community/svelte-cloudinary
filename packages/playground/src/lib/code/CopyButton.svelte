...
<style>
	...
	:global(:root[theme='light']) button:hover:hover {
		background: var(--bg-e);
		color: var(--bg-a);
	}
	:global(:root[theme='light']) button:hover.active,
	:global(:root[theme='light']) button:hover.outro {
