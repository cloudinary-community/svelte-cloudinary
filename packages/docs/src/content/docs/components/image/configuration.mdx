...
description: Options and configuration for CldImage in Svelte.
---
	...
	data={[
		{
			...
			more: () => (
				<a href="https://developer.mozilla.org/en-US/docs/Web/API/HTMLImageElement/alt#usage_notes">
					More Info
				</a>
			),
		},
		{
			...
			more: () => (
				<a href="https://developer.mozilla.org/en-US/docs/Web/API/HTMLImageElement/height">
					More Info
				</a>
			),
		},
		...
		},
		{
			...
			example: () => <code>600</code>,
			more: () => (
				<a href="https://developer.mozilla.org/en-US/docs/Web/API/HTMLImageElement/width">
					More Info
				</a>
			),
		},
