...
The `CldOgImage` component provides a simple way to use Cloudinary for your open graph image. It supports all the same transforms/effects as `<CldImage />`.
...
:::note
Twitter requires a [title](#title) to be set for the embed to work
:::
